...
- ## modify frequency
- ## get isomiRs sequences
- ## simulate reads

python simulation_sender.py --fasta all_seqs.fa 
		--folder example --reads PE --seqSys HS25 --fcov 10 -t 2 
		--freqs all_seqs.freqs.csv -n 10 -r 10 
		--art_bin ./art_illumina -m 50 -s 5 --database db_mirbase
